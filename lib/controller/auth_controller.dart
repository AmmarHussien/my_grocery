...
import '../service/local service/local_auth_service.dart';
import '../service/remote service/remote_auth_service.dart';
    ...
    try {
      ...
      if (result.statusCode == 200) {
        ...
        if (userResult.statusCode == 200) {
          ...
          EasyLoading.showError('Something wrong. Try again!1');
        }
      } else {
        EasyLoading.showError(result.body['message']);
      }
    } catch (e) {
      debugPrint(e.toString()+ 'a7aaa');
      EasyLoading.showError('Something wrong. Try again!3');
    } finally {
      EasyLoading.dismiss();
    }
  }
